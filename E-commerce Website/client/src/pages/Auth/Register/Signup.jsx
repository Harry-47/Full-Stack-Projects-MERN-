                ...
                >
                    ...
                    <div className="relative hidden lg:flex flex-1 items-center justify-center p-10 bg-black text-white overflow-hidden">
                        ...
                        >
                            ...
                            <p className="text-lg text-gray-400">Join the community. Elevate your style.</p>
                            <motion.img
                                src={logo}
                                alt="Aesthetic shoes"
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-500 mb-8 text-center">Join us and start your journey.</p>
                        ...
                        <Form method="post" className="space-y-6">
                            ...
                            >
                                <select
                                    name="role"
                                    required
                                    className="w-full p-3 pl-4 border border-gray-300 rounded-4xl outline-none focus:border-black transition-all duration-300 text-gray-600 cursor-pointer"
                                >
                            ...
                            >
                                <Link to={'/auth/login'} className="text-sm font-medium hover:text-gray-600 text-gray-400">Already have an account?</Link>
                            </motion.div>
