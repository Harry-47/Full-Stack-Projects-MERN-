            ...
            <div className="flex-1 flex justify-center items-center p-4 lg:p-10">
                ...
                >
                    ...
                    >
                        ...
                        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 text-center">Set New Password</h2>
                        ...
                        {message? (message.includes('successfully')? <p className="mt-4 text-center text-sm">{message}</p>: null) : null}
                    </motion.div>
                </motion.div>
            </div>
            <Footer />
