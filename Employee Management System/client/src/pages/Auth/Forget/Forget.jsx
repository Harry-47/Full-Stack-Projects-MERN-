        ...
        >
          ...
          >
            ...
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              className={` bg-cyan-50 border ${ msg.includes('sent') ? "border-green-400 text-green-700" : "border-red-400 text-red-700"} px-4 py-3 mb-10 rounded-lg flex items-center gap-2`}
            >
